---
description: Import instincts from teammates, Skill Creator, or other sources. Handles duplicate detection and conflict resolution with configurable merge strategies.
---
...
```bash
python3 "${CLAUDE_PLUGIN_ROOT}/skills/continuous-learning/scripts/instinct-cli.py" import <file-or-url> [--dry-run] [--force] [--min-confidence 0.7]
```
...
## New Instincts (8)
These will be added:
  + use-form-requests (confidence: 0.7)
...
These contradict local instincts:
  x use-services-for-logic
     Conflicts with: prefer-action-pattern
