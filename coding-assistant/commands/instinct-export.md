---
description: Export instincts for sharing with teammates or other projects. Filters by domain and confidence, strips sensitive information, and outputs shareable YAML/JSON/MD files.
---
...
instincts:
  - id: prefer-action-pattern
    ...
    action: "Use Action classes over fat controllers"
    confidence: 0.8
    domain: code-style
    observations: 8
  ...
  - id: test-first-workflow
    ...
    action: "Write Pest test first, then implementation"
    confidence: 0.9
    domain: testing
    observations: 12
